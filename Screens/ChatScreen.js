...
import { View, SafeAreaView, Text, Dimensions,TextInput, Alert, TouchableOpacity } from 'react-native';
...
export default class ChatScreen extends React.Component {
    ...
    render() {
        ...
        return (
            <SafeAreaView>
                <FlatList
                style={{padding:10,height:height*0.77}}
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginHorizontal:5 }}>
                    ...
                    />
                    <TouchableOpacity onPress={this.sendMessage}style={{paddingBottom:10,
                    marginLeft:5}}>
